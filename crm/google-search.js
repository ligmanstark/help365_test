        ...
        function outputSubCategoryResult(url) {
            switch (true) {
                ...
                case (/localhost/i.test(url)):
                    return 'localhost';
                    //prod
                case (/brix365.com\/ru\/help\/platform/i.test(url)):
                    return 'Platform';
                case (/brix365.com\/ru\/help\/ecm/i.test(url)):
                    return 'ECM';
                case (/brix365.com\/ru\/help\/crm/i.test(url)):
                    return 'CRM';
                case (/brix365.com\/ru\/help\/projects/i.test(url)):
                    return 'Projects';
                case (/brix365.com\/ru\/help\/business_solutions/i.test(url)):
                    return 'Business solutions';
                case (/brix365.com\/ru\/help\/service/i.test(url)):
                    return 'Service';
                default:
                    return '';
            }
