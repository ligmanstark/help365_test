...
["./2025_3.html","2025.3","Here is the list of changes that you can explore right now by activating the BRIX trial version.",""],
["./2025_3_op.html","2025.3","Version BRIX On-Premises 2025.3 includes all updates for BRIX SaaS 2025.3, as well as the following improvements:",""],
...
["./360006965372.html","Workspace settings","In workspace settings, system administrators can change the name of the workspace, describe how to use it, and select a new icon.",""],
...
["./360007722171.html","Export a workspace","You can export a workspace from one company to another or upload it to the BRIX Store catalog.",""],
...
["./360011756780.html","End Approval","The End Approval activity is used as an auxiliary element for the Approval block. It is placed on the process step where the final resolution on t...",""],
...
["./360012263332.html","Manage Status","The Manage Status activity is used only in the business processes that involve apps with customized statuses. It allows you to track the process p...",""],
...
["./360026936731.html","Document templates","A document template is a file that contains a certain set of variables. It can have the .doc, .docx, .xls, .xlsx or .rtf format  The values o...",""],
...
["./advanced-kubernetes-settings.html","BRIX Enterprise advanced settings","Advanced application settings in a Kubernetes cluster are tools for distributing workload across nodes. You can use them to control where and how ...",""],
...
["./affinity-antiaffinity.html","Load balancing rules for nodes","To improve fault tolerance and system performance, you can define flexible load balancing rules for nodes using the tools:",""],
...
["./another-template-syntax-functions.html","Special functions of template syntax","The article describes the rules of using additional functions of template syntax:",""],
...
["./business-process-metrics-examples.html","Use cases for customizing process indicators","Indicator of the Counter type Let&#39;s see how to customize the indicator using the Draw up and approve the contract process as an example. It consis...",""],
...
["./call-register-widget.html","Call log","The Call Log widget is used to track call information. With its help, you can:",""],
...
["./elma365-with-antivirus.html","BRIX and antivirus software","To maximize the performance and security of the BRIX system, it is important to properly configure the firewall and deploy key components such as ...",""],
...
["./embedded-to-external-database-enterprise-backupper.html","Data migration from embedded to external databases in BRIX Enterprise: customized utility","You can migrate data from databases within a Kubernetes cluster to external storages using:",""],
["./embedded-to-external-database-enterprise.html","Data migration from embedded to external databases in BRIX Enterprise","You can migrate data from databases within a Kubernetes cluster to external storages using:",""],
["./embedded-to-external-database-standard.html","Data migration from embedded to external databases in BRIX Standard","To increase flexibility and fault tolerance of the system, you can migrate data from databases inside the Kubernetes cluster to external storage. ...",""],
...
["./fail-safe-kubernetes-cluster.html","High-availability Kubernetes cluster","Deckhouse is a full-featured platform based on Open Source components that, in addition to Kubernetes, includes additional modules for monitoring,...",""],
...
["./navigation.html","Folder navigation","The widget is used in apps for which the folder hierarchy option is enabled. It allows you to:",""],
...
["./node-selector.html","Selecting nodes for pod placement","You can restrict pod placement to specific nodes using the  parameter. This is a simple Kubernetes tool that allows you to assign pods only t...",""],
...
["./pod-disruption-budget.html","Pod disruption budget","You can protect services from sudden disconnection. To do this, use the Pod Disruption Budget tool. It allows you to control how many pods can be ...",""],
["./pod-topology-spread-constraints.html","Node load balancing","To increase system resiliency during host or zone failures, configure the  parameter. This controls the even distribution of pods across the ...",""],
...
["./product-item-widget.html","Select Product widget for the product catalog","The Select Product widget is used to work with items of the Product Catalog app from the Product Catalog workspace. This widget helps to select a ...",""],
["./progress-change.html","Change of Project Task Progress","You can use the Change of Project Task Progress activity to edit the completion percentage for the project tasks of the Task and Milestone types i...",""],
...
["./project-plan-widget.html","Project plan widget","The widget is used on the project page to create, display, and edit the project plan.",""],
...
["./section_update.html","Update workspace","This feature allows you to automatically apply updates to a workspace from an .e365 file.",""],
["./security-context.html","Security settings for containers and pods","The Security Context tool in Kubernetes specifies security parameters for pods and containers, including the user name for running processes, what...",""],
...
["./substitution-add-working.html","Create and work with substitutions","You can work with substitutions in Administration &#62; Company &#62; Substitutions.",""],
...
["./taints-tolerations.html","Placing pods on nodes with restrictions","When you want to reserve nodes for critical services and stop other tasks from running on those nodes, you can use taints and tolerations.",""],
...
["./trash-folder.html","Trash and deleted files","To access the list of deleted files and their shortcuts, open the Files workspace in the main menu of the page and then select Trash.",""],
["./two-factor-integration.html","Custom module for two-factor authentication","You can enable two‑step authentication when logging in to the system or the external portal, so that a user enters a verification code as the...",""],
