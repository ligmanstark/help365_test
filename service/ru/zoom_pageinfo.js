...
["./connection_to_line.html","Подключить линию к мессенджерам","Вы можете связать линию с мессенджерами, чтобы клиенты смогли отправлять свои обращения через них, а операторы — отвечать на сообще...",""],
...
["./create-bot.html","Создание бота","Боты создаются в специальном конструкторе. начало внимание Добавлять и настраивать ботов могут только пользователи, входящие в группу Ад...",""],
...
["./customer-service.html","Клиентский сервис","Бизнес-решение Клиентский сервис является частью системного решения ELMA365 Service и предназначено для поддержки внешних клиентов ...",""],
...
["./kedo-goskey-module-settings.html","Модуль решения «Интеграция с Госключом»","После установки бизнес-решения Интеграция с Госключом в разделе Админитрирование &#62; Модули добавится одноимённый модуль. Он содержит:",""],
...
["./kedo-portal-sign-documents.html","Подписать кадровые документы","Участвуя в кадровых процессах компании, вы получаете на портале КЭДО задачи о подписании документов. Для этого используется выпущенный на ваше имя...",""],
...
["./operators-report.html","Отчёт «Загрузка сотрудников»","Отчёт позволяет оценить загруженность операторов. Можно посмотреть количество открытых и закрытых заявок, а также чисо обращений, при обработке ко...",""],
...
["./servicedesk-2.html","ServiceDesk 2.0","Бизнес-решение ServiceDesk 2.0 является частью системного решения ELMA365 Service и используется для автоматизации управления услугами. Решен...",""],
...
["./servicedesk.html","ServiceDesk","Бизнес-решение ServiceDesk является частью системного решения ELMA365 Service и используется для автоматизации управления услугами. В основе бизне...",""],
...
["./telegrambot.html","TelegramBot","Вы можете связать линию с TelegramBot, чтобы клиенты и партнёры могли отправлять свои обращения через мессенджер и получать ответ, сформирова...",""],
...
["./viberbot.html","ViberBot","Вы можете связать линию с ViberBot, чтобы клиенты и партнёры могли отправлять свои обращения через Viber и получать ответ, сформированный в и...",""],
["./vk-teams.html","VK Teams","Вы можете связать линию с VK Teams, чтобы сотрудники могли отправлять свои обращения через мессенджер и получать ответы, сформированные в&#38;nbs...",""],
["./vk.html","ВКонтакте","Вы можете связать линию с сообществом из ВКонтакте, чтобы клиенты смогли отправлять свои обращения через социальную сеть, а операторы — ...",""],
["./whatsapp.html","WhatsApp","Вы можете связать линию с WhatsApp, чтобы клиенты смогли отправлять свои обращения через мессенджер, а операторы — отвечать на них ...",""],
