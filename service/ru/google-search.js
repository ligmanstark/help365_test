...
function expandCurrentActiveLink() {
    ...
    export function isFakeLink(link) {
    ...
    export function findFirstRealNestedLink(element) {
    ...
    export function replaceFakeLinksInTOC(toc) {
        const fakeLinks = toc.querySelectorAll('a[href="javascript:void(0)"], a[href="#"]');
        fakeLinks.forEach(link => {
            const parentLi = link.closest('li');
            const nestedUl = parentLi?.querySelector('ul');
            const realLink = findFirstRealNestedLink(nestedUl);
            if (realLink) {
                link.setAttribute('href', realLink.getAttribute('href'));
            }
        });
    }
   ...
   `
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.addEventListener('subcategory:update', () => {
            setTimeout(insertCurrentSubDirectory, 50);
        });
    });
    ////////////////////////////////////////////////////////////////////////
