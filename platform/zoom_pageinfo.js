...
["./360006965372.html","Настройки раздела","В настройках раздела можно изменить его название, описать особенности работы с разделом и выбрать новую иконку.",""],
...
["./360011756780.html","Закрыть согласование","Графический элемент Закрыть согласование используется как вспомогательный для блока Согласование, если выбран способ согласования Вручну...",""],
...
["./activities-features.html","Биндинг и другие аспекты действий в бизнес-процессах","В пользовательском модуле можно создать исполняемый блок для бизнес-процесса. Если разместить такой графический элемент на схеме процесса, он буде...",""],
...
["./add-external-users.html","Добавить внешних пользователей","После настройки портала и его страниц активируйте пакет именных лицензий для внешних пользователей. Для этого обратитесь к менеджеру, у которого б...",""],
...
["./advanced-kubernetes-settings.html","Продвинутое изменение параметров ELMA365 Enterprise","Продвинутые параметры приложений в Kubernetes-кластере — это инструменты для распределения рабочей нагрузки между узлами. С их помощью вы можете к...",""],
...
["./call-process-activity.html","Вызов процесса","Такое действие позволяет вызвать процесс, настроенный в модуле на вкладке Процессы. Настройки действия выполняются на двух вкладках: Настройки и К...",""],
...
["./docker-hub-blocking.html","ELMA365 On-Premises и Docker Hub","Глобальный реестр образов Docker Hub был заблокирован 30.05.2024. ",""],
...
["./elma365-standard-trial-version.html","Установка ELMA365 Standard ознакомительная версия ","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание ELMA365 On-Pre...",""],
...
["./extention-activities.html","Действия в бизнес-процессах","Действие — это операция, выполняющаяся на определённом шаге бизнес-процесса. С помощью таких операций можно реализовать сложную разветвлённую логи...",""],
...
["./how_to_bind_app_to_proccess.html","Cвязать приложение ELMA365 с бизнес-процессом","Чтобы задать логику работы приложения, его можно связать с бизнес-процессом. Например, с приложением Договоры можно связать бизнес-процесс Согласо...",""],
...
["./install-kind-offline.html","Офлайн-установка ELMA365 Standard","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание ELMA365 редакц...",""],
...
["./install-kubernetes-in-docker.html","Установка ELMA365 Standard","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание ELMA365 редакц...",""],
...
["./installing-elma365-enterprise.html","Установка ELMA365 Enterprise в Kubernetes","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание Приложение ELM...",""],
...
["./navigation.html","Навигация по папкам","Виджет позволяет распределять по папкам элементы приложений, для которых включена опция Иерархический справочник. По умолчанию виджет добавлен на ...",""],
...
["./offline-version-update-enterprise.html","Офлайн-обновление версии ELMA365 Enterprise","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание Чтобы обеспечи...",""],
...
["./portable-microservices.html","Переносимые сервисы в модулях","Когда возможностей Low-code платформы недостаточно для оптимальной интеграции процессов в существующий информационный ландшафт, мы рекомендуем соз...",""],
...
["./project-plan-widget.html","План проекта","Виджет используется в карточке проекта для создания, отображения и редактирования плана проекта. ",""],
...
["./trash-folder.html","Корзина и удалённые файлы","Чтобы перейти к списку удалённых файлов, в главном левом меню страницы откройте раздел Файлы, а затем выберите Корзина.",""],
["./two-factor-integration.html","Пользовательский модуль для двухфакторной аутентификации","Вы можете включить двухэтапную аутентификацию при входе в систему, чтобы в качестве второго фактора использовался код подтверждения. Пользователь ...",""],
...
["./version-update-enterprise.html","Обновление версии ELMA365 Enterprise","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание Чтобы обеспечи...",""],
["./version-update-standard.html","Обновление ELMA365 Standard","начало внимание С 30.05.2024 заблокирован доступ из РФ к Docker Hub. Ознакомьтесь с официальным заявлением компании. конец внимание Процесс обновл...",""],
