...
["./display-spark-data.html","Настройки отображения данных СПАРК на форме приложения","Используя бизнес-решение Интеграция СПАРК вы можете получать данные о компании: расширенную справку, её статус, отчёт о рисках, информацию об изме...",""],
...
["./objects-search-element.html","Поиск печати, подписи, qr-кода, штрихкода","Графический элемент становится доступным в дизайнере бизнес-процессов после подключения модуля Поиск объектов в документе. Он позволяет с помощью ...",""],
...
["./purchases-fill-directories.html","Заполнение справочников «ELMA365 Закупки»","Для проведения закупочных процедур, оформления заказов и работы с поставщиками применяются данные из справочников — служебных приложений, в которы...",""],
["./purchases-initial-setup.html","Первичная настройка «ELMA365 Закупки»","ELMA365 Закупки включает в себя три бизнес-решения:",""],
["./purchases-reports.html","Отчёты по закупкам","На странице Отчет по закупкам отображаются сводные данные, которые помогают контролировать расходы и оценивать экономию средств. ",""],
...
["./spark-process-blocks.html","Моделирование процесса с блоками решения «Интеграция СПАРК»","После установки решения Интеграция СПАРК в дизайнер бизнес-процессов добавятся специальные графические блоки, каждый из которых соответствует...",""],
["./spark-requests-types.html","Типы запросов в сервис СПАРК","Интеграция с сервисом СПАРК позволяет получать различную информацию по компании, подписываться на её изменения с помощью опции мониторинга и загру...",""],
...
["./work-with-suppliers.html","Работа с поставщиками","Бизнес-решение Закупки содержит раздел SRM, который помогает организовать взаимодействие с поставщиками. В нём вы можете хранить информацию о конт...",""],
